      ...
      <main className="container-custom py-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-bold">🔍 {t('recruiters.title')}</h1>
          </div>
        ...
        <div className="card p-6 mb-6">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div>
              <select
                ...
                className="input w-full"
              >
                <option value="">🌍 {t('recruiters.allCountries')}</option>
          ...
          {recruiters && (
            <div className="mt-4 text-sm text-neutral-600">
              ✨ <strong>{recruiters.length}</strong> {t('recruiters.found', { count: recruiters.length })}
            </div>
          )}
        </div>
        ...
        {selectedRecruiter && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="card max-w-lg w-full p-6">
              <h3 className="text-xl font-bold mb-4">📧 {t('recruiters.introduceModalTitle')}</h3>
              ...
              <div className="flex gap-3">
                ...
                >
                  {sendContactRequestMutation.isPending ? t('recruiters.sending') : '✓ ' + t('common.submit')}
                </button>
              </div>
            </div>
          </div>
