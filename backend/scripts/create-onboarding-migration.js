...
async function createOnboardingMigration() {
  console.log('🚀 [MIGRATION] Création de la migration pour l\'onboarding...\n');
  ...
  try {
    ...
    console.log('\n🎉 [MIGRATION] Migration onboarding terminée avec succès !');

  } catch (error) {
    console.error('❌ [MIGRATION] Erreur lors de la création de la migration:', error);
    throw error;
  } finally {
